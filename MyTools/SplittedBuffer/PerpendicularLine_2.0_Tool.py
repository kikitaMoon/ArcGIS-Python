...
def createSplittedbufferfc(splitedBuffer, perplineFC, spatialReference):
    if arcpy.Exists(splitedBuffer):
        arcpy.Delete_management(splitedBuffer)
    arcpy.CreateFeatureclass_management(out_path=os.path.dirname(splitedBuffer),
    ...
    if perplineFC:
        ...
        arcpy.CreateFeatureclass_management(out_path=os.path.dirname(perplineFC),
